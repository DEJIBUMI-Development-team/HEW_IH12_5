...
<section class="new_gift">
  ...
  <div class="new_gift_menu1">
    <section class="new_gift_item">
      <a href="">
      <div class="item_name">
    ...
    <section class="new_gift_item">
      <a href="">
      <div class="item_name">
        <img src="../img/best8.jpg">
      <div class="item_title">
        <h3>出前館</h3>
        <p>2000円ギフト券</p>
        <div class="item_price">￥1,800</div>
        </div>
      </div>
    </section>
  </div>
